<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="采摘时间" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.timecaizhai | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="采摘数量" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.caizhainum }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="800px">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="采摘时间" prop="timecaizhai">
          <el-date-picker v-model="temp.timecaizhai" type="datetime" placeholder="Please pick a date" />
        </el-form-item>
        <el-form-item label="采摘数量" prop="caizhainum">
          <el-input v-model="temp.caizhainum" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        timecaizhai: [{ type: 'date', required: true, message: 'timecaizhai is required', trigger: 'change' }],
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.temp.timecaizhai = new Date(this.temp.timecaizhai)
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          tempData.timecaizhai = +new Date(tempData.timecaizhai) // change Thu Nov 30 2017 16:41:05 GMT+0800 (CST) to 1512031311464
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['timecaizhai', 'title', 'type', 'importance', 'status']
        const filterVal = ['timecaizhai', 'title', 'type', 'importance', 'status']
